...
from email_whitelist import urls as email_whitelist_urls
...
urlpatterns = [
    ...
    path("email_template/", include(email_template_urls)),
    path("email_whitelist/", include(email_whitelist_urls)),
