# Generated by Django 4.1.7 on 2023-04-26 18:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.EmailField(
                        error_messages={
                            "unique": "This email is already in the whitelist."
                        },
                        max_length=254,
                        unique=True,
                        verbose_name="email address",
                ...
                (
                    ...
                    models.CharField(
                        error_messages={
                            "unique": "This verification code already exists."
                        },
                        max_length=128,
                        unique=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "region",
                    models.CharField(
                        error_messages={"unique": "Deze regio bestaat al."},
                        max_length=40,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("date", models.DateField()),
                ("started_tour", models.DateTimeField(blank=True, null=True)),
                ("completed_tour", models.DateTimeField(blank=True, null=True)),
                ("current_building_index", models.IntegerField(default=0)),
                ("max_building_index", models.IntegerField(blank=True, null=True)),
                (
                    "student",
                    models.ForeignKey(
                        null=True,
        ...
        migrations.AddConstraint(
            model_name="remarkatbuilding",
            constraint=models.UniqueConstraint(
                django.db.models.functions.text.Lower("remark"),
                models.F("building"),
                models.F("student_on_tour"),
                models.F("timestamp"),
