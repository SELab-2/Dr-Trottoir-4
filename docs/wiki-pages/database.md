...
You can also connect to the actual database and request the data using SQL queries. However, 
you normally don't need this since we usually interact with it through the back-end.
...
database. You can also easily add, remove and edit entries on the admin page without having to write any SQL code. Just
make sure you have a superuser to login to the admin page. You can do this by either running the following command:
```bash
