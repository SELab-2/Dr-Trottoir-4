...
describe('PasswordModal', () => {
    ...
    it('handles password change submission', async () => {
        fireEvent.change(screen.getByPlaceholderText('Voer uw huidige wachtwoord in'), {target: {value: 'oldpassword'}});
        fireEvent.change(screen.getByPlaceholderText('Voer uw nieuwe wachtwoord in'), {target: {value: 'newpassword'}});
        fireEvent.change(screen.getByPlaceholderText('Voer uw nieuwe wachtwoord opnieuw in'), {target: {value: 'newpassword'}});
