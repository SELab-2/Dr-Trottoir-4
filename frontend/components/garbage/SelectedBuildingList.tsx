        ...
        <Modal show={show} onHide={() => closeModal()}>
            ...
            <Modal.Body>
                <div className="form-outline mb-4">
                    ...
                    {buildings.length <= 0 && <h6 className="mb-4">Er zijn geen gebouwen geselecteerd</h6>}
                    <ul>
                        {buildings.map((b) => (
                            <li key={b.id} value={b.id}>
                                {getAddress(b)}
                ...
                <div className="form-outline mb-4">
                    ...
                    <ul>
                        {Object.entries(selectedTours).map(([tourId, _]: [string, BuildingInterface[]]) => (
                            <li key={+tourId} value={+tourId}>
                                {getTourName(+tourId)}
                                <Tooltip arrow placement="right" title="Verwijder">
