...
function SyndicBuilding() {
    ...
    useEffect(() => {
        ...
        async function fetchBuildings() {
            getBuildingsFromOwner(id).then((buildings:AxiosResponse<any>  ) => {
            ...
            <>
                ...
                <div className="row">
                    ...
                    {buildings.map((building: BuildingInterface) => {
                        ...
                        return (
                            <div className="col-md-4 mb-3" key={building.id} onClick={e => {
                                e.preventDefault();
                                router.push({
                                    pathname: 'dashboard',
                            ...
                            >
                                <div className="card">
                                    <div className="card-body">
                                        <h5 className="card-title">{building.name} {building.postal_code} {building.city}</h5>
                                        <p className="card-text">{building.street} {building.house_number} </p>
                                    </div>
                                </div>
                            </div>
                        );
